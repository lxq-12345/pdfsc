...
任务：
  1. 与用户沟通，从测试素材中剪裁制作测试案例文件
  2. 起草 prompts/restore.md 初版提示词
  3. 用提示词处理三个层次表格
  4. 对比期望输出评分
  5. 调整提示词，连续3次稳定达标

通过标准：三个层次均≥9.7分，连续3次稳定
失败处理：调整提示词重新验证；<8.0分暂停报告用户
```
...
**任务清单**：
1. 实现忠实还原步骤（接入prompts/restore.md）
2. 实现中间产物保存（output/markdown/raw/*_raw.md）
3. 实现智能增强步骤（接入prompts/enhance.md）
